...
ui <- fluidPage(
  ...
  sidebarLayout(
    ...
    sidebarPanel(
      ...
      sliderInput("expTime", "Gün (daha sonraki günler için üstel dağılım model kestirimleri elde edilebilir)", value = 14, min = 1, max = 16, step = 1),
      ...
      HTML('<p>Son veri güncelleme: 24.03.2020, 00:25</p>')
